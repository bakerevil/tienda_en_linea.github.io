...
<header>
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
    <a href="adm-carrito.php" class="navbar-brand d-flex align-items-center">
        <strong class="btn btn-primary">carrito <?php echo $contador_carrito; ?> productos</strong>
      </a>
      <a href="index.php" class="navbar-brand d-flex align-items-center">
        <strong class="btn btn-secondary">regresar</strong>
      </a>
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
          ...
          <a href="catalogo_deportivo_A" class="btn btn-secondary my-2">catalogo de tenis deportivosn A</a>
          <a href="catalogo_marca_A" class="btn btn-secondary my-2">catalogo calzado de marca A</a>
        </p>
      </div>
    </div>
  </section>
          ...
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="acciones/adm-delete.php?id=<?php echo $row['id']; ?>" class= "btn btn-danger">eliminar</a>
              </div>
            </div>
          </div>
        </div>
